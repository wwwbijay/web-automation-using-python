...
from harray import nepaliHoroscopes, englishHoroscopes

# constants
base_url = 'https://apis.mypay.com.np/mypayadmin-prod/'
maxSigns = 13
...
for x in range(1, maxSigns):
    ...
    editor_body.clear()
    editor_body.send_keys(nepaliHoroscopes[x-1])
    ...
    editor_body1.clear()
    editor_body1.send_keys(englishHoroscopes[x-1])

    # Switch back from iframe to parent content
    driver.switch_to.parent_frame()

    print(englishHoroscopes[x - 1])
...
for x in range(1, maxSigns):
    ...
    editor_body1 = driver.find_element(By.TAG_NAME, 'body')
    editor_body1.clear()
    editor_body1.send_keys(nepaliHoroscopes[x - 1])
